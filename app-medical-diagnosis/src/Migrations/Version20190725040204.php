 ...
 */
final class Version20190725040204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE symptom_user (symptom_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_8ECE5BA5DEEFDA95 (symptom_id), INDEX IDX_8ECE5BA5A76ED395 (user_id), PRIMARY KEY(symptom_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_symptom (user_id INT NOT NULL, symptom_id INT NOT NULL, INDEX IDX_BCCFEEAADEEFDA95 (symptom_id), INDEX IDX_BCCFEEAAA76ED395 (user_id), PRIMARY KEY(user_id, symptom_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
